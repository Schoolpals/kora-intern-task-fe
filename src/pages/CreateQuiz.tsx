      ...
      <div>
       ...
       {count < 9  ? <form onSubmit={handleSubmit}>
          ...
          <div className='flex gap-[20px] items-center'>
            <label className="text-xl font-medium md:text-4xl">Question:</label>
            <input
              type="text"
              value={question}
          ...
          <div className='flex items-center gap-[20px]'>
            <label className="text-xl font-medium md:text-4xl">Options:</label>
